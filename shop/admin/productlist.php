...
?>
                  ...
                  <table class="table table-striped " id="prod">
                    ...
                    <tbody>
                      <?php 
                        ...
                        <a class='btn btn-primary btn-sm' style='background-color: red;' href='index.php?page=removeproduct&id=$product_id'>Delete</a>
      ...
      <script>
        ...
        $('.remove_product').click(function(){
            ...
            if(conf == true){
                $.ajax({
                    url:'delete_prod.php?id='+$(this).attr('data-id'),
